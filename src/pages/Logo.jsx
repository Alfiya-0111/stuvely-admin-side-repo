  ...
  return (
    <div className="p-5">
      ...
      <div className="mb-4">
        ...
        <select value={logoType} onChange={(e) => setLogoType(e.target.value)}>
      ...
      <div className="mb-4">
        ...
        <div className="flex gap-2 mt-2">
          ...
          <input
            ...
            className="border p-1"
          />
          <button onClick={addNavLink} className="bg-blue-500 text-white px-2">Add</button>
        </div>
      </div>

      <button onClick={handleSave} className="bg-green-500 text-white px-4 py-1">Save Changes</button>
    </div>
  );
}
